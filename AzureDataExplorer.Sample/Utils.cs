...
namespace QuickStart
{
    ...
    public static class Utils
    {
        ...
        public static class Authentication
        {
            ...
            public static KustoConnectionStringBuilder GenerateConnectionString(string clusterUrl, AuthenticationModeOptions authenticationMode, string clientId, string clientSecret,string tenantId)
            {
